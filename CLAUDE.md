# demo-ch-mortgageauto

Auto Mortgage Loan Case Review System — a shared internal tool for mortgage teams to tally client documents, calculate income by bank method, and determine max loan eligibility per bank, with built-in rules to prevent calculation errors.
